...
<head>
    ...
    <title><?php echo e($paket->nama_paket_localized); ?> | Rinjani Great Trek</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-image {
            ...
            height: auto;
            margin: 28px auto 0;
            background: url('<?php echo e($heroFoto?->image_url ?? asset('images/admin-login-bg.jpg')); ?>') center/cover no-repeat;
            border: 1px solid var(--line);
            border-radius: 16px;
        }
...
<body>
    ...
    <div class="page-shell">
        ...
        <section class="hero-image" aria-label="<?php echo e(__('site.package.photo_alt')); ?>"></section>

        <section class="detail-content" id="paket">
            <h1 class="paket-title"><?php echo e($paket->nama_paket_localized); ?></h1>
            <span class="paket-category"><?php echo e($paket->kategori ?? 'Umum'); ?></span>
            <div class="paket-price">$<?php echo e(number_format($paket->harga, 0, '.', ',')); ?></div>

            <div class="divider"></div>

            <p class="text-block"><?php echo e($paket->deskripsi_localized); ?></p>

            <div class="itinerary-wrap">
                <p class="label"><?php echo e(__('site.package.itinerary')); ?></p>
                <p class="text-block"><?php echo e($paket->itinerary_localized); ?></p>
            </div>

            <?php if(isset($recommendedPaketList) && $recommendedPaketList->count() > 0): ?>
                <div class="recommend-wrap">
                    <h2 class="recommend-title"><?php echo e(__('site.package.recommended_title')); ?></h2>
                    <p class="recommend-sub"><?php echo e(__('site.package.recommended_subtitle')); ?></p>
                    <div class="recommend-grid">
                        <?php $__currentLoopData = $recommendedPaketList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recommendedPaket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <a class="recommend-card" href="<?php echo e(route('paket.show', $recommendedPaket->id_paket)); ?>" style="background-image: url('<?php echo e($cardImage); ?>');">
                                <span class="recommend-badge"><?php echo e($recommendedPaket->kategori ?? 'General'); ?></span>
                                <div class="recommend-content">
                                    <div class="recommend-head">
                                        <h3><?php echo e($recommendedPaket->nama_paket_localized); ?></h3>
                                        <div class="recommend-price">$<?php echo e(number_format($recommendedPaket->harga, 0, '.', ',')); ?></div>
                                    </div>
                                    <div class="recommend-meta">
                                        <span><?php echo e($recommendedPaket->kategori ?? 'General'); ?></span>
                                        <span>Trip</span>
                                        <span>#<?php echo e($recommendedPaket->id_paket); ?></span>
                                    </div>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
