...
<head>
    ...
    <title><?php echo e(__('site.article.all_news')); ?> | Rinjani Great Trek</title>
...
<body>
    ...
    <div class="page-shell">
        ...
        <section class="content" id="artikel">
            <h1 class="page-title"><?php echo e(__('site.article.all_news')); ?></h1>
            <p class="page-sub"><?php echo e(__('site.article.all_news_subtitle')); ?></p>
                    ...
                    <?php $__currentLoopData = $artikelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artikel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="article-link" href="<?php echo e(route('artikel.show', $artikel->id_artikel)); ?>">
                            <article class="article-item">
                                <?php if($artikel->gambar_path): ?>
                                    <img
                                        class="article-thumb"
                                        src="<?php echo e($artikel->image_url); ?>"
                                        alt="<?php echo e($artikel->judul_localized); ?>"
                                    >
                                <?php else: ?>
                                    <div class="article-thumb"></div>
                                <?php endif; ?>
                                <div class="article-body">
                                    <h2 class="article-title"><?php echo e($artikel->judul_localized); ?></h2>
                                    <p class="article-desc"><?php echo e(\Illuminate\Support\Str::limit($artikel->deskripsi_localized, 180)); ?></p>
                                </div>
                            </article>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                <div class="empty"><?php echo e(__('site.article.empty')); ?></div>
            <?php endif; ?>
        </section>
    </div>
