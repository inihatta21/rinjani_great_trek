...
<body>
    <section class="panel">
        <div class="header">
            <h1 class="title">Tambah Data Paket</h1>
            <p class="sub">Isi form berikut untuk menambahkan paket baru.</p>
        </div>

        <div class="content">
            <form method="POST" action="<?php echo e(route('admin.paket.store')); ?>">
                <?php echo csrf_field(); ?>

                <div class="field">
                    <label for="nama_paket">Nama Paket</label>
                    <input id="nama_paket" type="text" name="nama_paket" value="<?php echo e(old('nama_paket')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input id="nama_paket_en" type="text" name="nama_paket_en" value="<?php echo e(old('nama_paket_en')); ?>">
                ...
                <div class="field">
                    ...
                    <select id="kategori" name="kategori_id" required>
                        ...
                        <?php $__currentLoopData = $kategoriList ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kategori->id); ?>" <?php echo e((string) old('kategori_id') === (string) $kategori->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input id="harga" type="text" name="harga" value="<?php echo e(old('harga')); ?>" inputmode="numeric" autocomplete="off" placeholder="example: 1,500" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <textarea id="deskripsi_en" name="deskripsi_en"><?php echo e(old('deskripsi_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <textarea id="itinerary" name="itinerary" required><?php echo e(old('itinerary')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <textarea id="itinerary_en" name="itinerary_en"><?php echo e(old('itinerary_en')); ?></textarea>
