...
<head>
    ...
    <title>Edit Data Berita</title><link rel="icon" type="image/svg+xml" href="{{ asset('favicon-rgt.svg') }}">
...
<body>
    <section class="panel">
        <div class="header">
            <h1 class="title">Edit Data Berita</h1>
            <p class="sub">Perbarui data berita sesuai kebutuhan.</p>
        </div>
        <div class="content">
            <form method="POST" action="{{ route('admin.artikel.update', $artikel->id_artikel) }}" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <input id="judul_artikel" type="text" name="judul_artikel" value="{{ old('judul_artikel', $artikel->judul_artikel) }}" required>
                    @error('judul_artikel')
                ...
                <div class="field">
                    ...
                    <input id="judul_artikel_en" type="text" name="judul_artikel_en" value="{{ old('judul_artikel_en', $artikel->judul_artikel_en) }}">
                ...
                <div class="field">
                    ...
                    <textarea id="deskripsi_en" name="deskripsi_en">{{ old('deskripsi_en', $artikel->deskripsi_en) }}</textarea>
                    @error('deskripsi_en')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="field">
                    ...
                    @if ($artikel->gambar_path)
                        <img class="current-image" src="{{ $artikel->image_url }}" alt="Gambar berita">
                    @endif
                </div>
