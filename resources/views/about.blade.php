...
<head>
    ...
    <title><?php echo e(__('site.about.title')); ?> | Rinjani Great Trek</title>
...
<body>
    ...
    <div class="page-shell">
        ...
        <section class="content">
            <h1 class="page-title"><?php echo e(__('site.about.title')); ?></h1>
            <div class="about-wrap">
                <?php $__currentLoopData = $aboutParagraphs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
